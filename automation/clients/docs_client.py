...
def create_doc(service_account_json: str, keyword: str) -> tuple[str, str]:
    docs = _get_service(service_account_json)
...
def write_analysis(service_account_json: str, keyword: str, analysis_text: str) -> str:
    doc_id, url = create_doc(service_account_json, keyword)
    docs = _get_service(service_account_json)
